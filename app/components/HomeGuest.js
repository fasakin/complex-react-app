        ...
        <div className="col-lg-5 pl-lg-5 pb-3 py-lg-5">
          <form onSubmit={handleSubmit}>
            ...
            <div className="form-group">
              ...
              <input onChange={(e) => setPassword(e.target.value)} id="password-register" name="password" className="form-control" type="password" autoComplete="off" placeholder="Create a password" />
            </div>
